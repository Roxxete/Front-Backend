...
app.listen(port, () => {
    ...
    console.log(`API REST ejecutandose en http://localhost:${port}/api-docs`);
    console.log(`APP de la web ejecutandose en http:/localhost`);
    console.log(`Datos de la bbdd ejecutandose en http://localhost:${port}/api/mediciones`);
});
